function yprime = mechanical_ode_TM_base_2d(t,y,q,D1X,D1Y,D2X,D2Y,D2XY,D2_bd,A_pos,A_pos_0,...
    A_pos_1,A_neg,A_neg_0,A_neg_1,xy_int,bd,total)
...
%      t
    ...
    v = velocity_solve(q,D1X,D1Y,D2X,D2Y,D2XY,D2_bd,n,rho,u,xy_int,bd,total);
