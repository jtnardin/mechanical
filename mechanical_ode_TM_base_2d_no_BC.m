%function mechanical_ode_TM_base_2d_no_BC.m written 9-6-17 by JTN to
%simulate 2d Tranquillo Murray model. This version is designed to not
%consider the boundary conditions in velocity computation for ease of
%simulation

function yprime = mechanical_ode_TM_base_2d_no_BC(t,y,q,dx,dy,...
...
%       t
    ...
    v = velocity_solve_2d_no_BC(q,D1X,D1Y,D2X,D2Y,D2XY,D2bd_D,n,rho,u,...
        xy_int,bd,total);
    ...
    dndt = ( q(9)*(D2X(x_int,total) + D2Y(y_int,total)  + D2Xbd_N(x_bd_0,x_bd_l,total)...
